...
function CSSTextGenerator(colors) {
  ...
  return `
    ...
    --ion-item-background-activated: ${contrast(light, 0.5)};
    --ion-color-step-600: ${contrast(dark, 0.3)};
    --ion-color-step-550: ${contrast(dark, 0.3)};
...
function contrast(color, ratio = 1.2) {
  color = Color(color);
